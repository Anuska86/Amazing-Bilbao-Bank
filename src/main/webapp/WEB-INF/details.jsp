           ...
           <h2 class="detail-balance">
            ...
            <div class="ownership-info">
                <div class="info-group">
                    <span class="small-label">Main Titular:</span>
                    <span class="info-value">${titular}</span>
                </div>

                <c:if test="${not empty cotitular}">
                    <div class="info-group">
                        <span class="small-label">Cotitular:</span>
                        <span class="info-value">${cotitular}</span>
                    </div>
                </c:if>
...
<a href="bank?action=dashboard" class="back-btn">&larr; Back to Dashboard</a>
</div>
</body>
</html>